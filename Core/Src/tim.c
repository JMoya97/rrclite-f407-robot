...
void MX_TIM2_Init(void)
{
  ...
  htim2.Init.Period = MOTOR_JGA27_TICKS_PER_CIRCLE - 1;
...
void MX_TIM3_Init(void)
{
  ...
  htim3.Init.Period = MOTOR_JGA27_TICKS_PER_CIRCLE - 1;
  htim3.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1;
  htim3.Init.AutoReloadPreload = TIM_AUTORELOAD_PRELOAD_ENABLE;
  sConfig.EncoderMode = TIM_ENCODERMODE_TI12;
  #if (MOTOR_POLARITY_3) < 0
    sConfig.IC1Polarity = TIM_ICPOLARITY_RISING;
  #else
    sConfig.IC1Polarity = TIM_ICPOLARITY_FALLING;
  #endif
...
void MX_TIM4_Init(void)
{
  ...
  htim4.Init.Period = MOTOR_JGA27_TICKS_PER_CIRCLE - 1;
  htim4.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1;
  htim4.Init.AutoReloadPreload = TIM_AUTORELOAD_PRELOAD_ENABLE;
  sConfig.EncoderMode = TIM_ENCODERMODE_TI12;
  #if (MOTOR_POLARITY_2) < 0
    sConfig.IC1Polarity = TIM_ICPOLARITY_RISING;
  #else
    sConfig.IC1Polarity = TIM_ICPOLARITY_FALLING;
  #endif
...
void MX_TIM5_Init(void)
{
  ...
  htim5.Init.Period = MOTOR_JGA27_TICKS_PER_CIRCLE - 1;
...
void MX_TIM6_Init(void)
{
  ...
  htim6.Instance = TIM6;
  htim6.Init.Prescaler = 8399;                      // 84 MHz / (8399+1) = 10 kHz
  htim6.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim6.Init.Period = 99;                           // 10 kHz / (99+1) = 100 Hz
